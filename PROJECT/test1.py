...
def making_files():
    """
    main idea is to take really large text
    and put there key and message in different places.
    $ - checker for main text
    & - checker for key text

    then i will xor this thrash text with some other text
    and replace using unicode
    """

    """
    input text

    1.0 - Птеооанвтср,яуии т лвм  ВиезКй
    1.1 - 123456
    ...
    # text variables
    # main_text = '$Птеооанвтср,яуии т лвм  ВиезКй$'  # $
    # key_text = '&654321&'  # &
