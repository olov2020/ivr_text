...
def change_all_task_files():
    change_task_file('task1')
    change_task_file('task2')
    change_task_file('task3')
    change_task_file('task4')
        ...
        def callback(*args):
            ...
            if variable.get() == 'Зашифровать':
                ...
                if len(pubkey_pem) != 0 and len(message_text.get(1.0, tk.END)) != 0:
                    encryption(message_text, result_text, pubkey_pem)
                else:
